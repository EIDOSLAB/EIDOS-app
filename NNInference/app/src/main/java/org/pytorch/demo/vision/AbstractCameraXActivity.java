...
public abstract class AbstractCameraXActivity<R> extends BaseModuleActivity {
  ...
  private void setupCameraX() {
    ...
    final ImageAnalysisConfig imageAnalysisConfig =
        new ImageAnalysisConfig.Builder()
            .setTargetResolution(new Size(getInputTensorWidth(),getInputTensorHeight()))
  ...
  protected abstract int getInputTensorHeight();

  protected abstract String[] getIntentInputDataset();

  protected abstract int getInputTensorWidth();
